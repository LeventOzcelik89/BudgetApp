    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2025, 1, 28, 23, 39, 5, 914, DateTimeKind.Local).AddTicks(3152), "admin@admin.com", true, "Admin", false, null, "Admin", "0RliDGV36n4zhibHsZF/wcGBPTAdGpjYhHVMZ3uM4MR4o0UKkhbtY8KrdIw8PeQiRpbo9VOMvvSkKyX1u3n/cA==", "grAyrNbHlCLK7ioqCs20kbCrDuqzh6u8FnNPZ4Ulcz3u2ynYNJN5FGerGDlxYVKE8DduF0KGa5k6GKDxVl94RT/0+UhKxHksl/wbfnJqU2zHU/clKI7iLTJAW1K6HQwATBRk240aK1RbGhByR5v62jsCELJOz46bNtrhuxmGi50=", null });

            migrationBuilder.InsertData(
                table: "UserSettings",
                columns: new[] { "Id", "BudgetPreferencesJson", "CreatedAt", "CurrencyCode", "IsDeleted", "Language", "NotificationPreferencesJson", "TimeZone", "UpdatedAt", "UserId" },
                values: new object[] { 1, "{\"AutomaticallyCategorizeTransactions\":true,\"WarnWhenBudgetExceeds\":true,\"WarnAtPercentage\":80,\"RolloverUnusedBudget\":false}", new DateTime(2025, 1, 28, 23, 39, 5, 916, DateTimeKind.Local).AddTicks(3376), "TRY", false, "tr", "{\"EnablePushNotifications\":true,\"EnableEmailNotifications\":true,\"NotifyOnBudgetExceeded\":true,\"NotifyOnGoalProgress\":true,\"NotifyOnLargeTransactions\":true,\"LargeTransactionThreshold\":1000}", "Europe/Istanbul", null, 1 });
